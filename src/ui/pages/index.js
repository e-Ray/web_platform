...
import { firebaseAuth, ref } from '../../api/Auth/_constants';
          ...
          <div>
            ...
            <div className="container">
              <div className="row">
                ...
                <MatchWhenAuthed authed={this.state.authed}
                 pattern="/dashboard" component={Dashboard} />
                <MatchWhenAuthed authed={this.state.authed}
                 pattern="/detailPagePerf" component={PERF} />
                <MatchWhenAuthed authed={this.state.authed}
                 pattern="/detailPageRain" component={RAIN} />
                <MatchWhenAuthed authed={this.state.authed}
                 pattern="/detailPageRpm" component={RPM} />
                <MatchWhenAuthed authed={this.state.authed}
                 pattern="/detailPageTemp" component={TEMP} />
                <MatchWhenAuthed authed={this.state.authed}
                 pattern="/detailPageWaterTemp" component={WTEMP} />
                <MatchWhenAuthed authed={this.state.authed}
                 pattern="/detailPageWindDir" component={WDIR} />
                <MatchWhenAuthed authed={this.state.authed}
                 pattern="/detailPageWindSpeed" component={WSPEED} />
                <MatchWhenAuthed authed={this.state.authed}
                 pattern="/detailPageWL" component={WL} />
                <MatchWhenAuthed authed={this.state.authed}
                 pattern="/InfoPage" component={InfoPage} />
                <MatchWhenAuthed authed={this.state.authed}
