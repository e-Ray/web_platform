  ...
  render() {
    return (
      ...
      <div id="container">
        ...
        <h2>Im Nachfolgenden finden sie Hilfe zur Bedienung der Webapplikation. Klicken Sie auf einen Eintrag um dafür Hilfe zu erhalten.</h2>
        <div id="row">
        ...
        <div id="row">
            <div id="help1">
              <h2>Dashboard - Werte ablesen</h2><br />
              <br />
              <p id="helppassage">Auf dem Dashboard haben Sie als Benutzer verschiedene Möglichkeiten ihre Werte gezielt abzulessen.<br />
              Es werden ihnen alle acht Sensoren angezeigt und Sie können einfach wie in Abbildung 1 mit der Maus für das gewünschte Datum im Graphen den Wert ablesen. <br />
              <br />
              <img src="help1.jpg" id="helpimage"/> <br />
              <br />
              ...
              <br />
              <img src="help2.png" id="helpimage"/> <br />
              <br />
              </p>
        ...
        <div id="row">
            <div id="help2">
              <h2>Detailseite - Zeitraum einstellen</h2><br />
              <br />
              <p id="helppassage">Auf den Detailseiten können Sie detailliertere Zeiträume einstellen um so genau zu sehen, welchen Wert der Sensor an einem bestimmten Datum gemessen hat.<br />
                ...
                <br />
                <img src="help3.jpg" id="helpimage"/> <br />
                <br />
                ...
                <br />
                <img src="help4.png" id="helpimage"/> <br />
                <br />
